...
/**
 * A minimal synchronous and thread-safe Redis API with SET, GET, MGET commands.
 * <p>
 ...
 * @since 3.0
 */
public interface RedisCommands<K, V> extends BaseRedisCommands<K, V>, RedisClusterCommands<K, V>, RedisStringCommands<K, V> {
