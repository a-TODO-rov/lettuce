...
class AsyncConnections {
    ...
    public CompletableFuture<Connections> asCompletableFuture(Duration timeout, ScheduledExecutorService timeoutExecutor) {
        ...
        return connections.getOrTimeout(timeout, timeoutExecutor).toCompletableFuture();
    }
