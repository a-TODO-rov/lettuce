...
public class ConnectionWatchdog extends ChannelInboundHandlerAdapter {
    ...
    private void run(int attempt, Duration delay) throws Exception {
        ...
        try {
            ...
            ReconnectionHandler.ReconnectFutures reconnectFutures = reconnectionHandler.reconnect();
            CompletableFuture<Channel> future = reconnectFutures.channelFuture;
            ...
            future.whenComplete((c, t) -> {
                ...
                CompletableFuture<SocketAddress> remoteAddressFuture = reconnectFutures.addressFuture;
